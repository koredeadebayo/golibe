						...
						<div class="col-lg-3">
							<div class="site-logo-wrapper">
								<a href="index-1.html" class="logo">
									<img src="assets/images/golibe-logo2.png" alt="Golibe logo_not_found">
								</a>
							</div>
						</div>
		...
		<section id="event-gallery-section" class="event-gallery-section sec-ptb-100 clearfix">
			<div class="container">
				...
				<div class="section-title text-center mb-80">
					<h2 class="big-title">The<img src="assets/images/golibe-logo2.png" width="100px" height="1000px"><strong>Experience</strong></h2>
				</div>
				<!-- section-title - end -->
