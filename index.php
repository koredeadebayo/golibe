											...
											<div class="overlay-black clearfix">
												...
												<div class="leftside-content">
													...
													<div class="copyright-text">
														<p class="m-0">©2018 <a href="#!" class="yellow-color">golibefestival.com</a> all right reserved, made with <i class="fas fa-heart"></i> by jThemes Studio </p>
													</div>
												</div>
										...
										<div id="login-modal" class="reglog-modal-wrapper mfp-hide clearfix" style="background-image: url(assets/images/login-modal-bg.jpg);">
											<div class="overlay-black clearfix">
												...
												<div class="leftside-content">
													...
													<div class="copyright-text">
														<p class="m-0">©2018 <a href="#!" class="yellow-color">golibefestival.com</a> all right reserved, made with <i class="fas fa-heart"></i> Golibe Festival </p>
													</div>
												</div>
												<!-- leftside-content - end -->
							...
							<div class="col-lg-8">
								<div class="slider-content">
									<div class="countdown-timer mb-30">
										<ul class="countdown-list" data-countdown="2018/01/01"></ul>
									</div>
		...
		<section id="event-gallery-section" class="event-gallery-section sec-ptb-100 clearfix">
			<div class="container">
				...
				<div class="grid-item grid-item--width2 photo-gallery " data-category="photo-gallery">
					<a class="popup-link" href="assets/images/gallery/2.image.jpg">
				...
				<div class="grid-item grid-item--width2 photo-gallery " data-category="video-gallery">
					<a class="popup-link" href="assets/images/gallery/5.image.jpg">
